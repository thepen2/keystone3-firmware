...
In addition we have applied some additional fixes that seemed to be causing problems in the compile.  To find them all, search for the words "BY PEN" in the archive.  The explanation for these other fixes can be found in the original https://github.com/KeystoneHQ/keystone3-firmware archive under Issues 1777 and 1781.
